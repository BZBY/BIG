<template>
  ...
  <div class="top"  :style="{'background-color': Day.day? '#000':''}">
    <div class="wrap">
      <div class="title">
        <img
          src="../assets/images/u=1668822078,957528629&fm=253&app=138&size=w931&n=0&f=JPEG&fmt=auto.webp"
          alt=""
        />&nbsp 编程Blog
      </div>
      <div class="desc">编程开发，分享实践社区</div>
    </div>
    ...
    <div class="user" v-if="User.isLogin">
      ...
      >
        <li
          ...
          @click="toPage(item)"
        >
          欢迎您 <span @click="toUserCenter">{{ User.userinfo.nickname }}</span>
        </li>
      </el-tooltip>
