    ...
    <div class="drafts">
        ...
        <ul>
            <li v-for="item in dra.list">
                <el-descriptions class="margin-top" :column="3" border>
                    ...
                    <el-descriptions-item span="3" label="摘要">{{item.desc}}</el-descriptions-item>
        ...
        <el-dialog v-model="isCheckDialog" title="博文详情" width="80%">
            <el-descriptions class="margin-top" :column="3" border>
                ...
                <el-descriptions-item span="3" label="摘要">{{current.article.desc}}</el-descriptions-item>
