...
//     if(status === 0){
//         User.regUser.id = '004'
//         User.regUser.username = register.username
//         User.regUser.password = register.password
//         User.regUser.nickname = register.nickname
//         User.regUser.email = register.email
